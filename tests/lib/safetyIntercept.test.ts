...
describe('checkSafety', () => {
  ...
  it('should return false for safe/normal text', () => {
    expect(checkSafety('I had a stressful day at work but I am feeling okay now.')).toBe(false);
    expect(checkSafety('I need to kill the process in task manager.')).toBe(false);
  });
