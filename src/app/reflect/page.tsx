...
export default function EndOfDayReflection() {
  ...
  async function handleSavePlan(e: React.FormEvent) {
    ...
    const tasksToInsert = [];
    if (tomorrowTask1.trim())
      tasksToInsert.push({
        title: tomorrowTask1.trim(),
        estimatedTime: "15 mins",
        emotionalIntensity: "Low",
        dueDate: tomorrowStr,
      });
    if (tomorrowTask2.trim())
      tasksToInsert.push({
        title: tomorrowTask2.trim(),
        estimatedTime: "15 mins",
        emotionalIntensity: "Low",
        dueDate: tomorrowStr,
      });
    if (tomorrowTask3.trim())
      tasksToInsert.push({
        title: tomorrowTask3.trim(),
        estimatedTime: "15 mins",
        emotionalIntensity: "Low",
        dueDate: tomorrowStr,
      });
    ...
    >
      {step === "intro" && (
        ...
        >
          ...
          >
            Take a few moments to offload your thoughts, release today's
            worries, and set a gentle path for tomorrow so your mind can rest.
          </p>
          <button
            type="button"
            onClick={handleBegin}
      ...
      {step === "decision_follow_up" && currentDecision && (
        ...
        >
          <div>
            <span
              className="badge-custom badge-sage"
              style={{
                fontSize: "0.75rem",
            ...
            >
              Recap check-in {currentExpiredIndex + 1} of{" "}
              {expiredDecisions.length}
            </span>
            <h2
              className="serif-heading"
              style={{
            ...
            >
              ...
              <strong>"{currentDecision.title}"</strong>. Which option did you
              choose, and how do you feel about it now?
            </p>
          </div>
      ...
      {step === "release" && (
        ...
        >
          <div>
            ...
            >
              Gently acknowledge a positive moment and put today's worries to
              rest.
            </p>
          </div>
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                Is there a worry you want to leave behind in the vault?
              </label>
              <textarea
                value={worry}
      ...
      {step === "plan" && (
        ...
        >
          <div>
            ...
            >
              List up to 3 gentle steps for tomorrow, so you don't have to carry
              them in your thoughts overnight.
            </p>
          </div>
      ...
      {step === "rest" && (
        ...
        >
          ...
          >
            Your worries are secured, your accomplishments are recognized, and
            tomorrow's steps are planned. You have cleared the path.
            <br />
            <br />
