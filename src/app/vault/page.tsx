...
type WorryStep =
  "input" | "question" | "released" | "schedule" | "scheduled_done";
...
export default function VaultsPage() {
  ...
  const [victoryCategory, setVictoryCategory] = useState<
    "Gratitude" | "Strength Validation" | "Exception to Problem" | "General"
  >("General");
    ...
    try {
      ...
      if (!res.ok) {
        if (data.error === "GEMINI_API_KEY_MISSING") {
          console.warn(
            "Gemini API Key is missing. Falling back to local offline dictionary.",
          );
        }
      ...
      console.error(err);
      alert(
        `AI Task Generation Failed: ${err.message || "Gemini API Error. Ensure GEMINI_API_KEY is configured."}`,
      );
      resolvedTasks = [];
    } finally {
      setLoading(false);
    ...
    <div style={{ padding: "2rem 0", maxWidth: "700px", margin: "0 auto" }}>
      <header style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "1.1rem", color: "#555" }}>
          Safeguard your worries or lock in your triumphs.
        </p>
        <Link
          href="/"
          style={{
      ...
      {activeVault === "worry" && (
        <div style={{ animation: "fadeIn 0.4s ease" }}>
          ...
          {worryStep === "input" && (
            ...
            >
              <label
                style={{ fontSize: "0.95rem", color: "#555", fontWeight: 600 }}
              >
                Deposit a worry to offload it safely from your mind:
              </label>
              <textarea
                value={worry}
          ...
          {worryStep === "question" && (
            ...
            >
              ...
              >
                Your worry has been successfully written down and locked in.
                Now, let's decide how to approach it.
              </p>
              <h3
                style={{
                  fontSize: "1.15rem",
              ...
              >
                Is this worry something you can take action on?
              </h3>
          ...
          {worryStep === "released" && (
            ...
            >
              ...
              >
                Since this worry is out of your control, carrying it will not
                change the outcome. We have locked it safely in the vault so
                your mind doesn't have to carry it. Take a deep breath and let
                it rest.
              </p>
              <button
                type="button"
                onClick={handleResetWorry}
          ...
          {worryStep === "schedule" && (
            ...
            >
              ...
              >
                ...
                >
                  Review, edit, and schedule the coping steps generated from
                  your worry.
                </p>
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            value={task.title}
                            onChange={(e) =>
                              updatePendingTask(index, "title", e.target.value)
                            }
                            style={{
                              width: "100%",
                              padding: "0.6rem",
          ...
          {worryStep === "scheduled_done" && (
            ...
            >
              ...
              >
                Your steps have been successfully scheduled and written to your
                Action Planner. You can review and complete them anytime.
              </p>
              <div
                style={{
                  display: "flex",
        ...
        <div style={{ animation: "fadeIn 0.4s ease" }}>
          ...
          >
            <div style={{ flex: "2 1 250px" }}>
              ...
              >
                Deposit a Win or Gratitude in your Victory Vault:
              </label>
              <input
                type="text"
                value={newVictory}
          ...
          {fetchingVictories ? (
            ...
            >
              ...
              >
                Your Victory Vault is currently empty. Whenever you experience a
                win, a positive reflection, or a glimmer of happiness, write it
                down here to preserve it.
              </p>
            </div>
          ) : (
            <div
