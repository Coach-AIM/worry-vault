    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#777', margin: 0, fontSize: '0.95rem' }}>Create Private Locker</p>
        </div>

        {success ? (
          <div style={{ textAlign: 'center', padding: '1rem 0' }}>
            <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎉</div>
            <h3 style={{ color: 'var(--sage-green)', margin: '0 0 0.5rem 0' }}>Account Created!</h3>
            <p style={{ color: '#666', fontSize: '0.9rem' }}>Redirecting to sign-in page...</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.85rem' }}>
              ...
              <Link href="/login" style={{ color: 'var(--sage-green)', fontWeight: 600, textDecoration: 'none' }}>
                Sign In
              </Link>
            </div>
          </form>
